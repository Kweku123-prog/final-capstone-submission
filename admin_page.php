...
<head>
  ...
  <link rel="stylesheet" href="css/admin.css?v=1652870200386">
          ...
          <div class="flex items-center justify-between">
            <div class="widget-label">
              <h3>
               <?php
            $total_pendings = 0;
            $select_pendings = mysqli_query($conn, "SELECT * FROM `orders` ") or die('query failed');
