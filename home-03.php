					...
					<?php
       				...
       				?>
						<div class="block2-pic hov-img0 label-new" data-label="New">
							...
							<img src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt="not working" >
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php?pid=<?php echo $fetch_products['id']; ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
